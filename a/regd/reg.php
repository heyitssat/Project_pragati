...
if(isset($_GET['error']) && $_GET['error']==1){
    echo "<strong><h3 style='text-align:center'>You Need to Sign In</h3></strong>";
}elseif(isset($_GET['error']) && $_GET['error']==2){
    echo "<strong><h3 style='text-align:center'>You Are successfully logged out. THANKS for Signing In</h3></strong>";
}
?>
                    ...
                    <div class=" col-sm-12 col-lg-4 col-md-3" style="float:right">
                        <div class="div-trans text-center">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12" >
                                ...
                                <div class="form-group">
                                    <?php
                                             echo '<div style="text-align:center;"><p class="error_message" style="font-family:verdana;" onclick="newDoc()" id="but" value="1">Forgot Password?</p>
  <p id ="error1"></p></div>';
?>
                                </div>
                             </div>
...
function newDoc() {
    ...
    window.location.assign("http://localhost/xampp/reg/changepass.php?user="+x+"")
    }
}
