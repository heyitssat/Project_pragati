...
<body>
        ...
        <div class="Banner_sec" id="home">
            ...
            <div class="bannerside">
	            <div class="Center">
                    ...
                    <div class="leftside">
                        <h1>PRAGATI</h1>
                   <h3>A WING OF COMMUNITY WELFARE CELL</h3>
                   <h3>IIT KANPUR</h3>
        ...
        <div id="Container">
            ...
            <div class="About_sec" id="about">
                <div class="Center">            	
                    <h2>ABOUT US </h2>            		
                    <p>Pragati is a social innovation wing that works on the principles of serving the society. Our society is facing various economic, environmental and social problems. The wing believes that innovations are the key to tackle these problems to improve our communities. Based on these beliefs, the wing shall work on creating, developing and implementing practices as well as providing innovative solutions to some of the common problems that exist now.</P>
                    <div class="Line"></div>	
                    <!-- \\ Begin Tab side \\ -->
                    <div class="Tabside">
                        <ul>
                    ...
                    <div class="Mid">					
                        ...
                        <div class="Rightside">
                            <h3>Get in touch !</h3>
                                ...
                                <address> 
                                   NEW SAC , IIT KANPUR 208016
                                </address>	
                                <address class="Number">
                                   +91 8604926503
                                </address>	
                                <address class="Email">
                                    <a href="mailto:info@november.com">aarav@iitk.ac.in</a>
                                </address>	
                                <div class="clear"></div>
                                <ul>
